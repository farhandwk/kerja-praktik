              ...
              <motion.div variants={fadeInUp}>
                ...
                <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    { title: "Kusam", type: "Visual/Kimia", desc: "Oksidasi material karena lapisan tipis. Stripping & re-plating.", img: "https://placehold.co/600x400?text=Dokumentasi+Tidak_Tersedia" },
                    { title: "Sealermark", type: "Visual/Kimia", desc: "Oksidasi material karena lapisan tipis. Stripping & re-plating.", img: "https://placehold.co/600x400?text=Dokumentasi+Tidak_Tersedia" },
                    { title: "Watermark", type: "Visual/Kimia", desc: "Oksidasi material karena lapisan tipis. Stripping & re-plating.", img: "https://placehold.co/600x400?text=Dokumentasi+Tidak_Tersedia" },
